    ...
    <div class="banner-block-wrapper">
      <div class="container">
        <div class="banner-block-content-wrapper">
          <h1 class="banner-kids-title title-for-pc">Khóa Luyện Nói 1 Kèm 1 <br /> Với Giáo Viên Người Nước Ngoài Cho Bé
          </h1>
          <h1 class="banner-kids-title title-for-mb">Khóa Luyện Nói <br />1 Kèm 1 <br /> Với Giáo Viên Người <br /> Nước
            Ngoài
            Cho Bé
          </h1>
          ...
          <div class="banner-content">
            <div class="left-content">
              <div class="image-background">
                <img src="./images/girl-image.png" class="kid-image kid-image-for-pc" alt=" kid-image-pc" />
                <img src="./images/girl-image-mb.png" class="kid-image kid-image-for-mb" alt=" kid-image-mb" />
              </div>
              <div class="content">
                <ul class="list-option">
                  <li class="option-item">
                    <img src="./images/icon-tick.png" class="icon-tick" alt="icon-tick" />
                    <p class="option-text">
                  ...
                  <li class="option-item">
                    <img src="./images/icon-tick.png" class="icon-tick" alt="icon-tick" />
                    <p class="option-text">
                      Cam kết chuẩn đầu ra Cambridge
                    </p>
                  </li>
                  <li class="option-item">
                    <img src="./images/icon-tick.png" class="icon-tick" alt="icon-tick" />
                  ...
                  <li class="option-item">
                    ...
                    <p class="option-text">
                      ...
                      <span class="hight-light">chứng chỉ giảng dạy quốc tế</span>
                    </p>
                  </li>
                </ul>
              </div>
            ...
            <div class="right-content">
              ...
              <div class="register-form">
                <form method="" action="">
                  <input type="text" name="" class="input-form" value="" placeholder="Họ tên" />
                  <input type="text" name="" class="input-form" value="" placeholder="Số điện thoại" />
                  <input type="text" name="" class="input-form" value="" placeholder="Tuổi con" />
                  <button type="" class="btn-register">ĐĂNG KÝ HỌC THỬ</button>
                </form>
              </div>
              <div class="bottom-image">
                <img src="./images/bottom-form-image.png" class="bottom-form-image" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="learn-with-foreigner-teacher-content">
          <div class="title-block">
            <div class="common-title-with-background title-1 learn-with-foreigner-teacher-title">
            ...
            <div class="right-content">
              <ul class="list-option-of-class">
                <li class="option-of-class-item">
                  <img src="./images/icon-tick-2.png" class="icon-tick" alt="">
                  <p class="text">Lớp học chỉ có 1 giáo viên nước ngoài và 1 bé.</p>
                </li>
                <li class="option-of-class-item">
                  <img src="./images/icon-tick-2.png" class="icon-tick" alt="">
                  <p class="text">Con được chỉ lỗi sai khi
                    phát âm, dùng từ và được
                    hướng dẫn lại cho đúng.</p>
                </li>
                <li class="option-of-class-item">
                  <img src="./images/icon-tick-2.png" class="icon-tick" alt="">
                  <p class="text">Học cùng 100% giáo viên
                    nước ngoài, hình thành
                    phản xạ giao tiếp tự nhiên.</p>
                </li>
      ...
      <div class="container">
        <div class="title-block-wrapper">
          ...
          <div class="common-title-with-background title-2">
            <h1 class="title-text txt-uppercase">cùng giáo viên nước ngoài tại Bitu</h1>
          </div>
        </div>
      ...
      <div class="container">
        <div class="title-block-wrapper">
          <div class="common-title-with-background recommend-title">
            <h1 class="title-text txt-uppercase">Bitu được VTV khuyên dùng</h1>
          </div>
        </div>
      ...
      <div class="container">
        <div class="title-content-wrapper">
          <div class="top-title-wrapper">
            <img src="./images/icon-bitu-12.png" class="icon-bitu-12" alt="">
          ...
          <div class="bottom-title-wrapper">
            <div class="mask"></div>
            <h3 class="text-title">con tiến bộ kỹ năng giao tiếp nhờ sử dụng Bitu</h3>
        ...
        <div class="teacher-team-of-bitu-content">
          <div class="top-content">
            ...
            <div class="core-value-list-wrapper">
              ...
              <ul class="core-value-list">
                <li>
                  <img src="./images/target-image.png" class="target-image" alt="">
                  <p class="text">100% giáo viên là người nước ngoài, được tuyển chọn
                    qua 4 vòng hồ sơ, phỏng vấn và training.</p>
                </li>
                <li>
                  <img src="./images/target-image.png" class="target-image" alt="">
                  <p class="text">Có nhiều năm kinh nghiệm giảng dạy tiếng Anh và
                    hiểu tâm lý các bé.</p>
                </li>
                <li>
                  <img src="./images/target-image.png" class="target-image" alt="">
                  <p class="text">Tất cả giáo viên đều có chứng chỉ sư phạm quốc tế uy tín như TESOL, TEFL và CELTA.
                  </p>
                </li>
              </ul>
            </div>
          ...
          <div class="list-teach-wrapper">
            <div class="list-teach-block">
              ...
              <div class="slider-wrapper native-teacher-slider teacher-team-of-bitu-slider-1">
                ...
                <div class="native-teacher-list teacher-team-of-bitu-1">
          ...
          <!-- START LIST TEACHER FOREINGER -->
          <div class="list-teach-wrapper list-foreigner-teacher">
            <div class="list-teach-block">
              <div class="title-wrapper">
                <div class="country-flag">
                  <img src="./images/country-flag.png" class="flag-image" alt="">
              ...
              <div class="slider-wrapper native-teacher-slider teacher-team-of-bitu-slider-2">
                <button class="btn-slider btn-prev">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_5877_8811)">
                      <path d="M15 6L9 12L15 18" stroke="#1A202C" stroke-width="2" stroke-linecap="round"
                ...
                <div class="native-teacher-list teacher-team-of-bitu-2">
                  <div class="slider-item">
                    <div class="teacher-image-wrapper">
                      <img src="./images/teacher.jpg" class="teacher-image" alt="">
                      <img src="./images/country-flag.png" class="flag-image" />
    ...
    <div class="topic-block-wrapper">
      <div class="container">
        <div class="topic-block-content">
          <img src="./images/lamp-image-1.png" class="lamp-1-image topic-icon" alt="">
          <img src="./images/icon-star-1.png" class="topic-icon icon-star-1" alt="">
          <div class="top-title-wrapper">
            <div class="title-1-wrapper">
              <div class="mask"></div>
          ...
          <div class="topic-content-wrapper">
            <div class="left-content">
              <img src="./images/phone-topic-image.png" class="phone-image" alt="">
            </div>
            <div class="right-content">
              <ul class="list-topic-content">
                <li class="topic-conten-item">
                  <img src="./images/icon-star-2.png" class="icon-star-2" alt="">
                  <p class="text-content">Các chủ đề luyện nói được gợi ý theo
                    trình độ của trẻ.</p>
                </li>
                <li class="topic-conten-item">
                  <img src="./images/icon-star-2.png" class="icon-star-2" alt="">
                  <p class="text-content">Đa dạng chủ đề từ giao tiếp hàng ngày
                    cho đến chủ đề khoa học, kỹ năng mềm
                    như hùng biện, thuyết trình...</p>
                </li>
                <li class="topic-conten-item">
                  <img src="./images/icon-star-2.png" class="icon-star-2" alt="">
                  <p class="text-content">Mỗi chủ đề đi kèm dàn ý với câu trả lời
                    gợi ý và hệ thống từ vựng.</p>
                </li>
              </ul>
              <img src="./images/lamp-image-2.png" class="lamp-2-image" alt="">
            </div>
